...
public class Workshop implements IWorkshop {
    ...
    private List<String> educationalResources;

    private static final String FILE_NAME = "workshop.txt";
    private FileManager fileManager;

    // Constructor to initialize the workshop with its details
    public Workshop(String title, String topic, String date, String speaker, FileManager fileManager) {
        this.title = title;
        this.topic = topic;
        this.date = date;
        this.speaker = speaker;
        this.attendees = new ArrayList<>();
        this.educationalResources = new ArrayList<>();
        this.fileManager = fileManager;
    }

    // Getters for the workshop details
    @Override
